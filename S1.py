...
class S1(Task):
    ...
    def __init__(self):
        ...
        self.info = """
        ########   TASK INFO   ########
        This task teaches mice to approach the lickport. Passive learning, at the moment
        of the lick, the reward is already delivered. 
    ...
    def create_trial(self):
        ...
        self.bpod.add_state(
            state_name='led_on',
            state_timer=300,
            state_change_conditions={Event.Tup: 'drink_delay', self.poke_side: 'drink_delay'},
